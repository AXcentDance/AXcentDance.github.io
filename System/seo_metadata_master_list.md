# SEO Metadata Master List

This file tracks the Title Tags and Meta Descriptions for all pages on the AXcent Dance website. Use this for Google Ads setup and SEO auditing.
...
| Page | File | Title Tag | Meta Description |
| :--- | :--- | :--- | :--- |
| **Bachata Beginner 0** | `class-bachata-beginner-0.html` | Bachata Beginner 0 Class | AXcent Dance | Your first step into the world of Bachata. No experience needed. Join our absolute beginner course. |
| **Bachata Beginner 2** | `class-bachata-beginner-2.html` | Bachata Beginner 2 Class - AXcent Dance | Start Your Journey | Level up your basics. For those who have completed Beginner 0 or have some experience. |
| **Sensual Foundation** | `class-bachata-sensual-foundation.html` | Bachata Sensual Foundation Classes Zurich | AXcent Dance | detailed foundation course for Bachata Sensual. Learn body waves, isolations, and connection. |
| **Sensual Improver** | `class-bachata-sensual-improver.html` | Bachata Sensual Improver | AXcent Dance Zurich | Improve your flow and complex figures. For dancers with a solid foundation. |
| **Sensual Inter/Adv** | `class-bachata-sensual-inter-adv.html` | Bachata Sensual Inter/Adv | AXcent Dance Zurich | Advanced combinations and musicality for experienced dancers. Challenge yourself. |
| **Lady Styling** | `class-lady-styling.html` | Bachata Lady Styling Classes Zurich | AXcent Dance | Focus on your elegance, arm styling, and body movement. Classes designated for followers. |

## Legal
| Page | File | Title Tag | Meta Description |
| :--- | :--- | :--- | :--- |
| **Terms** | `terms.html` | Terms and Conditions – AXcent Dance Zurich | Terms and Conditions (AGB) for AXcent Dance Zurich. |
| **Privacy Policy** | `privacy.html` | Privacy Policy – AXcent Dance Zurich | Privacy Policy (Datenschutzerklärung) for AXcent Dance Zurich. |
| **Imprint** | `imprint.html` | Imprint – AXcent Dance Zurich | Imprint (Impressum) for AXcent Dance Zurich. |

## Blog Posts
| Page | File | Title Tag | Meta Description |
| :--- | :--- | :--- | :--- |
| **Connection 101** | `connection-101.html` | Connection 101 | It is not about the moves, it is about the feeling. 3 simple tips to instantly improve your connection with any partner. |
| **Dance Tips: Frame** | `dance-tips-1-frame.html` | Dance Tips: Frame | Improve your Bachata leading and following with better frame technique. Learn the do's and don'ts of arm positioning and connection. |
| **What to Wear** | `what-to-wear-bachata.html` | What to Wear for Bachata | Wondering what to wear for your first Bachata class? Here is our complete guide on clothes, shoes, and hygiene. |
...
| Page | File | Title Tag | Meta Description |
| :--- | :--- | :--- | :--- |
| **Login** | `_login.html` | Login - AXcent Dance | Login to your AXcent Dance account to view your class history and rewards. |
| **Sign Up** | `_signup.html` | Sign Up - AXcent Dance | Create an account with AXcent Dance to join our loyalty program and track classes. |
| **Student Portal** | `portal.html` | Student Portal | AXcent Dance | View your class history, rewards, and progress at AXcent Dance. |
| **Thank You (Contact)** | `thank-you.html` | Thank You – AXcent Dance | Thank you for your interest in AXcent Dance. We will be in touch soon. |
| **404 Error** | `404.html` | Page Not Found – AXcent Dance | The page you are looking for does not exist. Return to AXcent Dance homepage. |
